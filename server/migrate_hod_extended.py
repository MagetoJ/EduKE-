...
def main():
    ...
    try:
        ...
        print("Altering assets table to add department_id...")
        cur.execute("ALTER TABLE assets ADD COLUMN IF NOT EXISTS department_id INT REFERENCES academic_departments(id) ON DELETE SET NULL;")
        ...
        print("✅ SUCCESS: Extended HOD Database columns and rosters are securely live!")
        cur.close()
        conn.close()
